...
class Genre(models.Model):
    name = models.CharField(
        _("name"),
        max_length=200,
        help_text=_("Name of the genre (for example: detective, sci-fi, horror...)"),
    )
...
class Book(models.Model):
    ...
    summary = models.TextField(
        _("description"), max_length=1000, help_text=_("Short book description")
    )
    ...
    genre = models.ManyToManyField(
        Genre, help_text=_("choose genre(s) for this book"), verbose_name=_("genre")
    )
...
class BookInstance(models.Model):
    ...
    id = models.UUIDField(
        primary_key=True,
        default=uuid.uuid4,
        help_text=_("Unique ID for each book instance"),
    )
    book = models.ForeignKey(
        "Book", on_delete=models.SET_NULL, null=True, verbose_name=_("book")
    )
...
class BookReview(models.Model):
    book = models.ForeignKey(
        "Book", on_delete=models.SET_NULL, null=True, blank=True, verbose_name=_("book")
    )
